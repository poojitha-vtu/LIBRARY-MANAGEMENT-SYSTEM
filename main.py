...
background_image = Image.open(r"C:\Users\saipo\OneDrive\Pictures\lib.jpg")
...
headingLabel = Label(headingFrame1, text="Welcome to My Library", bg='black', fg='white', font=('Times',15))
...
btn3 = Button(root, text="View Book ", bg='black', fg='white',command=View)
